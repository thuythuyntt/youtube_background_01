...
public class FavouriteFragment extends Fragment implements FavouriteVideosContract.View {
    ...
    private void initializationViews(View view) {
        RecyclerView recyclerFavouriteVideo = view.findViewById(R.id.recycler_favourite_videos);
        LinearLayoutManager llm = new LinearLayoutManager(getContext());
        recyclerFavouriteVideo.setLayoutManager(llm);
        mAdapter = new VideoAdapter();
        recyclerFavouriteVideo.setAdapter(mAdapter);
    }
